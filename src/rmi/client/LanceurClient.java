...
//		Client c = new Client(1099,"192.168.1.5");
		ClientChat cC = new ClientChat(1099, "192.168.1.79", "Jumbaa", 2000);
		ClientChat cC2 = new ClientChat(1099, "192.168.1.79", "Zerooid", 2111);
		ClientChat cC3 = new ClientChat(1099, "192.168.1.79", "Le3emeType", 2222);
